...
const AccountNav = () => {
  ...
  return (
    <nav className="mt-24 mb-8 flex w-full flex-col justify-center gap-2 p-8 md:flex-row md:p-0">
      ...
      <Link className={linkClases('received-requests')} to={'/account/received-requests'}>
        <svg xmlns="http://www.w3.org/2000/svg"
          ...
          stroke="currentColor"
          className="h-6 w-6">
          <path path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4.414a1 1 0 0 0-.707.293L.854 15.146A.5.5 0 0 1 0 14.793zm5 4a1 1 0 1 0-2 0 1 1 0 0 0 2 0m4 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0m3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
        </svg>
        Request Received
      </Link>
    </nav>

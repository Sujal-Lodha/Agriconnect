...
//   // Added contact and address to the state
...
//     setLoading(true);
//     const { name, password, confirm_password, contact, address } = userData;
...
//     try {
//       // Check if picture is updated and upload if necessary
//       let pictureUrl = '';
//       if (picture) {
//         pictureUrl = await uploadPicture(picture);
//       }

//       // Create the updated user details object including complete profile data
//       const userDetails = {
//         name,
//         password,
//         picture: pictureUrl,
...
//           {/* New fields for complete profile data */}
//           <div className="grid grid-cols-4 items-center gap-4">

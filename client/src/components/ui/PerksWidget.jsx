    ...
    <div className="mt-4">
      ...
      <div className="mt-4 grid flex-col gap-4 lg:grid-cols-2 lg:justify-items-stretch lg:gap-4">
        <div className="flex gap-4">
          ...
          <span className={`${perks?.includes('Helper') ? '' : 'line-through'}`}>
            Helper
          </span>
        </div>
        <div className="flex gap-4">
          ...
          <span className={`${perks?.includes('Labour Delivery') ? '' : 'line-through'}`}>
            Delivery Facility
          </span>
        </div>
        <div className="flex gap-4">
          ...
          <span
            className={`${perks?.includes('Fuel') ? '' : 'line-through'}`}
          >
            Fuel
          </span>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <span className={`${perks?.includes('Speedy Output') ? '' : 'line-through'}`}>
            Speedy Output
          </span>
        </div>
        <div className="flex gap-4">
          <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-clock-fill" viewBox="0 0 16 16">
            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71z" />
          </svg>
          <span className={`${perks?.includes('Skilled workforce') ? '' : 'line-through'}`}>
            Skilled workforce
          </span>
        </div>
        <div className="flex gap-4">
          ...
          <span
            className={`${perks?.includes('Flexible Working hours') ? '' : 'line-through'}`}
          >

...
const SearchBar = () => {
  ...
  return (
    <>
      <div className="flex w-4/6 h-12 overflow-hidden rounded-full border-[4px] border-lime-500 bg-gray-300 shadow-sm hover:shadow-lg md:w-1/2">
        <div className="grow">
          <input
            type="search"
        ...
        <div className="bg-blue flex cursor-pointer  items-center bg-lime-500 text-black">
          <button
